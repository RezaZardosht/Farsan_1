...
public class MainMenu extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		final Button Btn_Parametes = (Button)findViewById(R.id.btn_Parameters);
		Btn_Parametes.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				startActivity(new Intent(MainMenu.this, Parameters.class));
			}
		});
